        ...
        <div className='container'>
          <div className='text-center'>
            ...
            <h3 className='section-subheading text-muted'>
              We have the experience, the drive, the knowledge, and the ability
              to help your organization with any aspect of research– or the
              entire research process. We specialize in program evaluation,
              survey writing, and data analysis– we can even assist your
              organization in writing grants to fund your project research.
            </h3>
          </div>
          <div className='row text-center'>
            <div className='col-md-4'>
              ...
              <p className='text-muted'>
                ...
                statistical analyses, and people who do data analysis every day.
              </p>
            </div>
            <div className='col-md-4'>
              <span className='fa-stack fa-2x'>
              ...
              <p className='text-muted'>
                We know the best way to contact the people you want to hear from
                and how to ask questions in the proper format that makes your
            ...
            <div className='col-md-4'>
              ...
              <p className='text-muted'>
                Need help understanding your data? We will analyze your data and
                give you the highest quality report that is polished and ready
                for distribution!
              </p>
            </div>
